...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const menuButton = document.querySelector('.header__open-nav-button');
    ...
    const enableDarkMode = () => {
        ...
        header.classList.add('header_darkmode');

        // Cambiar nav
        if (navDarkMode) {
            navDarkMode.classList.add('header__nav-darkmode');
        }
        ...
        if (profileSection) {
            const dataContainer = profileSection.querySelector('.profile__data-container');
            if (dataContainer) {
    ...
    const disableDarkMode = () => {
        // Restaurar header
        header.classList.remove('header_darkmode');
        header.classList.add('header');

        // Restaurar nav
        if (navDarkMode) {
            navDarkMode.classList.remove('header__nav-darkmode');
        }
